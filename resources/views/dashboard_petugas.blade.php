...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="petugas" viewBox="0 0 16 16">
    ...
    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm9 1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5M9 8a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4A.5.5 0 0 0 9 8m1 2.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5m-1 2C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 0 2 13h6.96q.04-.245.04-.5M7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0"/>
        ...
        <symbol id="lelang" viewBox="0 0 16 16">
        ...
        <symbol id="penawaran" viewBox="0 0 16 16">
    ...
    <nav class="navbar " style="background-color: #C379A2">
        <div class="container-fluid">
            ...
            <a class="navbar-brand text-white text-sm-end">petugas</a>
        </div>
    </nav>
    ...
    <div id="main" class="main d-flex">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-dark bg-light"
            ...
            <div class="dropdown container text-align-center">
                ...
                <span class="fs-6">App Lelang</span>
            </div>
            <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <a href="/data-petugas" class="nav-link text-dark">
                    <svg class="bi me-2" width="16" height="16">
                ...
                <li>
                    <a href="/data-petugas" class="nav-link text-dark">
                        <svg class="bi me-2" width="16" height="16">
                            <use xlink:href="#petugas" />
                        </svg>
                        Data Lelang
                    </a>
                </li>
                <li>
                    <a href="/data-masyarakat" class="nav-link text-dark">
                        <svg class="bi me-2" width="16" height="16">
        ...
        <div id="isi-kontent" style="width: 100%; max-width: calc(100% - 280px)" class="container-fluid mt-3">
            @yield('konten-utama')
        </div>
